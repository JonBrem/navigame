templates.map_list = 
   ['<div class="small-12 columns">',
    ...
    '                  <button type="button" class="alert button" id="remove_map_button">Remove Map</button>',
    '               </div>',
    '               <div class="small-12 columns">',
    '                  <button type="button" class="success button" id="submit_path_button">Submit Path</button>',
    '               </div>',
    '           </div>',
    '       </div>',
    '   </div>',
