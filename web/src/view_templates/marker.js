templates.marker_controls = 
       ['<div id="controls-section">',
        ...
        '                   <button type="button" class="button marker-edit-button disabled"><i class="fi-pencil"></i> Bearbeiten</button>',
        '               </div>',
        '               <div class="small-6 columns marker_controls_button_container">',
        '                   <button type="button" class="alert button marker-delete-button disabled"><i class="fi-trash"></i> Entfernen</button>',
        '               </div>',
        '           </div>',
        '       </div>',
        '   </div>',
